 ...
 * @author vfern
 */
public class JDPlantaModificar extends javax.swing.JFrame {
    int ultimo;
    String idpro;
    ProductoMg p = new ProductoMg();
    PlantaMg pmg = new PlantaMg();

    public JDPlantaModificar() {
        initComponents();
    }
    
    public JDPlantaModificar(Planta p, String id) {
        initComponents();
        comboidpla();
        Planta pla = p;
        txtclima.setText(pla.getClima());
        txtcuidados.setText(pla.getCuidadosEsp());
        txthumedad.setText(String.valueOf(pla.getHumedad()));
        txtid.setText(id);
        txtluz.setText(pla.getLuz());
    ...
    private void initComponents() {
        ...
        txtnombreplanta.setEditable(false);
    ...
    private void btnsiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnsiguienteMouseClicked
        ...
        if (txtclima.getText().equals("")||txtcuidados.getText().equals("")||txthumedad.getText().equals("")||txtluz.getText().equals("")) {
            ...
            int idpla = Integer.parseInt(txtid.getText());
            ...
            int resp = JOptionPane.showConfirmDialog(null, "¿Los datos ingresados son los correctos?", "Alerta!", JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE);
                ...
                Planta pla = new Planta(p, txtnombreplanta.getText(), txtclima.getText(), humedad, txtcuidados.getText(), txtluz.getText());
                pmg.updatePlanta(pla, idpla);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDPlantaModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JDPlantaModificar().setVisible(true);
            }
        });
    }
