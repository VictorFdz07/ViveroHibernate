 ...
 * @author vfern
 */
public class JDZonaPersonalModificar extends javax.swing.JFrame {
    ...
    public JDZonaPersonalModificar() {
        initComponents();
    }
    
    public JDZonaPersonalModificar(ZonaPersonal z, String id) {
        initComponents();
        comboidper();
        comboidzon();
        ...
        ZonaPersonal zp = z;
        txtidzp.setText(id);
        dcfechafin.setDate(zp.getFechahr_fin());
        dcfechaini.setDate(zp.getFechahr_ini());
    }
    ...
    private void btnsiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnsiguienteMouseClicked
        ...
        if(txtnombrepersona.getText().equals("")){
           ...
           int id = Integer.parseInt(txtidzp.getText());
           ...
           if (resp == 0) {
               ...
               Session session = HibernateUtil.getSessionFactory().openSession();
               session.beginTransaction();
               z = (Zona) session.get(Zona.class, idz);
               p = (Personal) session.get(Personal.class, idp);
               
               ZonaPersonal zp = new ZonaPersonal(dcfechaini.getDate(), dcfechafin.getDate(), p, z);
               
               zpmg.updateExistencia(zp, id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDZonaPersonalModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JDZonaPersonalModificar().setVisible(true);
            }
        });
    }
