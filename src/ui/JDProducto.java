 ...
 * @author vfern
 */
public class JDProducto extends javax.swing.JFrame {
    Producto p;
    ...
    public JDProducto() {
        ...
        if (pmg.countProducto() != 0) {
            ultimo = pmg.countProducto() + 1;
            idpro = String.valueOf(ultimo);
        } else {
            idpro = "1";
        }
        txtidproducto.setText(idpro);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JDProducto().setVisible(true);
            }
        });
    }
