 ...
 * @author vfern
 */
public class JDAmbienteModificar extends javax.swing.JFrame {
     ...
     * @param id
     */
    public JDAmbienteModificar(Ambiente a, String id) {
        initComponents();
        Ambiente amb = a;
        txtidamb.setText(String.valueOf(id));
        dcfechaini.setDateFormatString("yyyy-MM-dd");
        this.setLocationRelativeTo(null);
        comboidzon();
        txthumedad.setText(String.valueOf(amb.getHumedad()));
        txttemperatura.setText(String.valueOf(amb.getTemperatura()));
        dcfechaini.setDate(amb.getFechahr());
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(txtnomzona, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(dcfechaini, javax.swing.GroupLayout.DEFAULT_SIZE, 146, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnsiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnsiguienteMouseClicked
        ...
        if(txthumedad.getText().equals("")||txttemperatura.getText().equals("")){
            ...
            int id = Integer.parseInt(txtidamb.getText());
            int resp = JOptionPane.showConfirmDialog(null, "¿Los datos ingresados son los correctos?", "Alerta!", JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE);
                if (resp == 0) {
                    ...
                    Ambiente a = new Ambiente(z, humedad, temperatura, dcfechaini.getDate());
                    amg.updatePersonal(a,id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDAmbienteModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JDAmbienteModificar().setVisible(true);
            }
        });
    }
